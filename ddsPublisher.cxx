...
int32_t main() {
    try{
        ...
        dds::topic::Topic<sensorData::msg> presTopic(pub_participent_entity, "PRESSURE_TOPIC");
        ...
        std::thread pres_thread(temp_sensor_data, std::ref(tempWriterObj), 220.0, 350.0);
        std::thread flow_thread(temp_sensor_data, std::ref(tempWriterObj), 500.0, 1000.0);
